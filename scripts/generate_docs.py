...
def evo_example_for_transition(key: str):
    ...
    Prefer examples rendered by the typed transition registry. Operations that are
    not yet executable in the UI retain explicit documentation-only examples here.
    """
